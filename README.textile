...
A super-lightweight (less than 100 LOC) lightbox-esque jQuery plugin (with jQuery UI support!)

h2. jQuery UI is not Supported (YET)

This is alpha software.  Once I figure out how to use jQuery UI, you can bet I'll have additional classes in here to get the fancy-pants styles that everyone drools over.  For now, you'll have to wait.
